...
**Output location:**
```
src-tauri/target/release/bundle/msi/Simple Budget Tracker_1.0.3_x64_en-US.msi
```
...
**Output location:**
```
src-tauri/target/release/bundle/dmg/Simple Budget Tracker_1.0.3_aarch64.dmg  (Apple Silicon)
src-tauri/target/release/bundle/dmg/Simple Budget Tracker_1.0.3_x64.dmg      (Intel)
```
...
4. ✅ Build complete! v1.0.3 Installers ready at:
